...
This repository is a local portfolio demonstration and is not hardened for production or public-network exposure. The default MQTT broker permits anonymous local access for a zero-setup demo.
